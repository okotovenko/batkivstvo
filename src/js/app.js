...
import "./files/forms/my_inputmask.js";
...
/* Модуль listjs для реалізації пошуку/сортування/фільтрації
Документація по работі в шаблоні:
Документація плагіна - https://listjs.com/docs/*/
//import './libs/list.min.js'

// Створення svg-лінії по обраним елементам з певним класом
// Документація https://github.com/tomislavjezidzic/draad
import './libs/createSVGLine.js'

// ========================================================================================================================================================================================================================================================
// Прочее ========================================================================================================================================================================================================================================================
// ========================================================================================================================================================================================================================================================
/* Подключаем файлы со своим кодом */
import * as script from "./files/script.js";

/* Анімація пунктів меню "хвилею при наведенні" */
//script.linksForVawe();

/* Власний курсор, стилізувати в сss, в html створити div.cursor */
// script.cursor();

/* Власний курсор + Магнітний курсор */
//script.cursorMove();

/* Анімація заголовків "хвилею" */
//script.titleForVawe();

/* Додавання класу "animation"*/
// script.animationElements()

/* Видалення тексту з кнопки "відео"*/
//script.deleteTextSpanVideo()

/* Прелоадер, стилізувати в сss, в html створити div.preloader*/
script.preloader()

/* Запуск svg-анімації */
//script.animationSvg()

/* Рандомна поява елементів в блоці (працює при перезавантаженні сторінки) */
// script.showElementRandom()

/* Зміна розміру SVG */
//script.toChangeSVGSize()
